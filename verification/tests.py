...
TESTS = {
    ...
    "Extra": [
        ...
        {
            'input': ['A2', 'B1', 'B2', 'B3', 'C2', 'C3', 'D2', 'E1',
                      'B5', 'B6', 'C6', 'C7', 'C8', 'D6',
                      'F4', 'F5', 'G5', 'G6', 'G7', 'H5', 'H6',
                      'G3', 'H2', 'H3', 'I2', 'I4', 'J2', 'J3', 'K2', 'K3',
                      'K4', 'L2', 'K7', 'L6'],
            'answer': [1, 2, 6, 7, 7, 12],
            'explanation': ['I3'],
        },
        {
            'input': ['B7', 'C6', 'C7', 'C8', 'D5', 'D6', 'D7',
                      'E3', 'E4', 'E9', 'F1', 'F2', 'F4', 'F6', 'F7', 'F8',
                      'G1', 'G2', 'G3', 'G4', 'G5', 'G6', 'G9',
                      'H2', 'H4', 'H5', 'H8', 'I6', 'I7', 'I8', 'J7'],
            'answer': [7, 29],
            'explanation': ['F3', 'G7', 'G8', 'H6', 'H7'],
        },
        {
            'input': ['A8', 'A9', 'B7', 'B8', 'D6', 'D8', 'E6', 'E8',
                      'F5', 'F6', 'G6', 'G7', 'H5', 'H7',
                      'I4', 'I5', 'I6', 'I7', 'J1', 'J2', 'J4', 'J5', 
                      'K1', 'K2', 'K3', 'L2'],
            'answer': [2, 4, 6, 15],
            'explanation': ['H6'],
        },
